...
function Add() {
  ...
  const handleAddProduct = async (e) => {
    try {
      ...
      console.log("try to opem ",serverUrl)
      const result = await axios.post(`${serverUrl}/api/product/addproduct`,formData,{ withCredentials: true }); console.log(result.data);
  ...
  >
    ...
    />
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] '>
            ...
            <textarea className='w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] py-[10px] text-[18px] placeholder:text-[#ffffffc2] ' placeholder='Type here' onChange={(e) => setDescription(e.target.value)} value={description} required ></textarea>
          </div>
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] '>
            ...
            <input type='number' className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px]  py-[10px] text-[18px] placeholder:text-[#ffffffc2] ' placeholder='₹ 2000' onChange={(e) => setPrice(e.target.value)} value={price} required></input>
          </div>
          ...
          {/* Check Box  for BestSeller  */}
          <div className='w-[80%] flex items-center justify-start gap-[10px] mt-[20px] '>
            <input type='checkbox' id='checkbox' className=' w-[25px] h-[25px] cursor-pointer ' onChange={() => setBestseller(prev => !prev)}></input>
